...
<head>
  <meta charset="UTF-8">
  <title>Retr (Akshay Vriddhi) - Executive MasterClass User Flow Documentation</title>
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    p { font-size: 12.5px; margin-bottom: 8px; color: #4a4039; }
    ...
    ul { margin-left: 16px; font-size: 12px; margin-bottom: 8px; color: #4a4039; }
...
<body>
  ...
  <div class="page">
    <div class="header-banner">
      <span class="badge">Akshay Vriddhi • Platform Blueprint</span>
      <h1>Retr MasterClass User Flow Documentation</h1>
    ...
    <p>
      ...
      The core user experience rejects aggressive sales funnels, popup clutter, and dark patterns in favor of a calm, authoritative, decision-first architecture.
    </p>
  ...
  <div class="page">
    ...
    <div class="flow-step">
      ...
      <div class="step-content">
        ...
        <p>The user lands on the home section. High-contrast wine & gold accents frame the value proposition with immediate clarity.</p>
        <div class="card">
          <ul>
            <li><strong>Hero Display:</strong> Executive badge pill, glowing gold headline (<em>"Retire without asking anyone for money."</em>), topic quick tracks (Corpus Gap, SWP vs Annuity, Family Vault).</li>
    ...
    <div class="flow-step">
      ...
      <div class="step-content">
        ...
        <p>The user accesses 9 decision-first calculators. No sign-up barriers exist.</p>
        <div class="card">
          <ul>
    ...
    <div class="flow-step">
      ...
      <div class="step-content">
        ...
        <p>A 7-question diagnostic quiz evaluating retirement readiness across cash flow, medical cover, tax, and estate protection.</p>
        <div class="card">
          <ul>
  ...
  <div class="page">
    <div class="flow-step">
      ...
      <div class="step-content">
        ...
        <p>Clicking any <em>"Request a call"</em> CTA triggers a clean, glassmorphic modal overlay.</p>
        <div class="card">
          <ul>
    ...
    <div class="flow-step">
      ...
      <div class="step-content">
        ...
        <p>Advisors receive incoming leads in real-time within the secure administrative portal.</p>
...
async function buildPdf() {
  ...
  const htmlPath = path.join(publicDir, 'user_flow.html');
  const pdfOutputPath = path.join(publicDir, 'Retr_MasterClass_User_Flow.pdf');
