...
const ROUTES = [
  {
    ...
    description:
      'What you build deserves to continue. Protection advice grounded in two decades of insurance experience, and a secure family vault for the documents your family may need.',
    priority: '1.0',
    heading: 'What you build deserves to continue.',
    body: 'Akshayvriddhi helps individuals and families create prosperity, protect continuity, live with confidence and transfer what they have built with purpose. Create. Continue. Live. Leave a Legacy.',
  },
  {
    path: '/about',
    file: 'about.html',
  ...
  },
  {
    ...
    body: 'Six questions, scored on our server and stored nowhere. An indicative self-assessment, not financial or insurance advice.',
  },
  {
    path: '/contact',
    file: 'contact.html',
  ...
  {
    path: '/create-vault',
    file: 'create-vault.html',
    title: 'Create your vault — Akshayvriddhi',
    description: 'One encrypted place for the documents your family may need, reachable by the people you trust.',
    priority: '0.7',
    heading: 'Create your vault',
    body: 'Every document is encrypted with its own key before it touches disk.',
  },
  {
    path: '/sign-in',
    file: 'sign-in.html',
    title: 'Sign in — Akshayvriddhi',
    description: 'Sign in to your Akshayvriddhi vault.',
    priority: '0.5',
    heading: 'Welcome back.',
    body: 'Your vault is where you left it.',
  },
  {
    path: '/privacy',
    file: 'privacy.html',
