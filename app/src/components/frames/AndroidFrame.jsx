// Simplified Android (Material 3) device frame, ported from the Claude
// Design export's android-frame.jsx starter for use as a real app module.
...
export { AndroidStatusBar, AndroidAppBar, AndroidListItem, AndroidNavBar, AndroidKeyboard };
