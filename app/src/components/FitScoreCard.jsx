...
// Chrome-free fit-score explanation card (originally screen 3c) — used
// standalone in a phone frame (gallery) and directly in the website.
  ...
  return (
    <div style={{ background: '#fff', fontFamily: 'Archivo, sans-serif', color: '#201e1d' }}>
      ...
      <div style={{ padding: '16px 20px', display: 'flex', gap: 10 }}>
        <button className="btn btn-primary" style={{ flex: 1 }}>CONTINUE WITH THIS</button>
        <button className="btn btn-ghost">SHOW THE SCORE BREAKDOWN</button>
      </div>
    </div>
  );
}
