...
// Screen 4a — the one interactive wireframe in the handoff: a tappable
// action → why → options → decided flow. The source used <sc-if>/{{ }}
// template bindings (isHome/isGap/isOpts/isDone, goHome/goGap/goOpts/goDone);
// this is that same state machine as real React state.
const STEP_LABELS = {
